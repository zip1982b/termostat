...
void vDrawMenu(uint8_t menuitem, uint8_t state, uint8_t temp, uint8_t contrast, esp_chip_info_t chip_info, uint8_t sensors, uint8_t status_relay, float temp_average, char* pIP, char* pMask, char* pGW)
{
	...
	/*** network info view ***/
		...
		SSD1306_Puts(pIP, &Font_7x10, SSD1306_COLOR_WHITE);
		SSD1306_GotoXY(5, 27);
		SSD1306_Puts("mask:", &Font_7x10, SSD1306_COLOR_WHITE);
		SSD1306_Puts(pMask, &Font_7x10, SSD1306_COLOR_WHITE);
		SSD1306_GotoXY(5, 37);
		SSD1306_Puts("gw:", &Font_7x10, SSD1306_COLOR_WHITE);
		SSD1306_Puts(pGW, &Font_7x10, SSD1306_COLOR_WHITE);
